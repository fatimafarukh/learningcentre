        ...
        <form class="ays-quiz-category-form" id="ays-quiz-category-form" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7 ays_divider_left">
                                            ...
                                            <div class="col-sm-12 ays_toggle_target ays_divider_top" style="margin-top: 10px; padding-top: 10px;">
                                                ...
                                                <select id="ays_answers_border_style" class="ays-text-input">
                                            ...
                                            <div class="col-sm-12 ays_toggle_target ays_divider_top" style="margin-top: 10px; padding-top: 10px;">
                                                ...
                                                <input id="ays_answers_border_color" class="ays-text-input" type="text" data-alpha="true" value="#000" data-default-color="#000000">
                                            </div>
                                        </div>
                                    </div> <!-- Answers border -->
                                    <hr/>
                                        ...
                                        <div class="col-sm-12 only_pro" style="padding:10px 0 0 10px;">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    ?>
                                                    <label class="ays_quiz_rw_icon">
                                                        <input name="ays_ans_right_wrong_icon_1" type="radio" value="style-<?php echo $i; ?>" <?php echo $ans_right_wrong_icon == 'style-'.$i ? 'checked' : ''; ?>>
                                                        <img class="right_icon" src="<?php echo AYS_QUIZ_PUBLIC_URL; ?>/images/<?php echo $right_style_name; ?>.png">
                                                        <img class="wrong_icon" src="<?php echo AYS_QUIZ_PUBLIC_URL; ?>/images/<?php echo $wrong_style_name; ?>.png">
                                                    </label>
                                                    <?php
            ...
            <div id="tab3" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab3') ? 'ays-quiz-tab-content-active' : ''; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="checkbox" class="ays-enable-timerl" id="ays_enable_arrows" name="ays_enable_arrows" value="on" <?php echo (isset($options['enable_arrows']) && $options['enable_arrows'] == 'on') ? 'checked' : ''; ?>/>
                    </div>
                ...
                <div class="form-group row" style="position:relative;">
                    <div class="col-sm-12" style="padding:15px;">
                        ...
                        <div class="form-group row ays_toggle_parent">
                            ...
                            <div class="col-sm-1">
                                <input type="checkbox" class="ays-enable-timer1 ays_toggle_checkbox" id="ays_enable_password" value="on" />
                            </div>
                            <div class="col-sm-8 ays_toggle_target ays_divider_left">
